...
export default function KanbanPage() {
  const { tasks, clients, addTask, updateTaskStatus, deleteTask } = useData();
    ...
    <div className="space-y-6 animate-fadeIn text-neutral-900">
      ...
      {selectedTaskDetail && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-xs">
          <div className="w-full max-w-xl bg-white border border-neutral-200 rounded-2xl shadow-xl p-6 space-y-4">
